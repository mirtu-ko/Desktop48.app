...
import type { AllMemberItem, MemberDataContent, StarInfoItem } from '../main/data'
...
export type { AllMemberItem, MemberDataContent }
...
/** getAllMembers 返回：h5.48.cn 落库的 allmembers 成员名单（见 main/data.ts 对应类型） */
